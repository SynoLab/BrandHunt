...
<div id="page-content">
    ...
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img class="blur-up lazyload" data-src="site/assets/images/cat-women2.jpg" src="site/assets/images/cat-women2.jpg" alt="Women" title="Women" /></div>
                        ...
                        <div class="widget-content">
                            <ul class="sidebar_categories">
                                @foreach($categories as $category)
                                    <li class="lvl-1"><a href="#" class="site-nav"> {{$category->category_name}} </a></li>
                                @endforeach
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-4 col-md-4 col-lg-4 filters-toolbar__item collection-view-as d-flex justify-content-start align-items-center">
                                    <a href="shop-left-sidebar.html" title="Grid View" class="change-view change-view--active">
                                        <img src="site/assets/images/grid.jpg" alt="Grid" />
                                    </a>
                                    <a href="shop-listview.html" title="List View" class="change-view">
                                        <img src="site/assets/images/list.jpg" alt="List" />
                                    </a>
                                </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 grid-view-item style2 item">
                        <div class="grid-view_image">
                            ...
                            <a href="{{ route('product.show', $product->id) }}" class="grid-view-item__link">
                                ...
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="grid-view-item__image hover blur-up lazyload" data-src="{{ asset('storage/' . $product->image) }}" src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" title="{{ $product->name }}" />
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                            ...
                            <div class="product-details hoverDetails text-center mobile">
                                ...
                                <!-- End product price -->
                                <!-- product review -->
                                <!-- Assuming you have a review system, you can display stars based on review ratings -->
