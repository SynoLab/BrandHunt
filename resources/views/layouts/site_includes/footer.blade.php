...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-4">
            ...
            <p>Enhance Communication: Integrating a Contact Form into Your Project </p>
            <div class="formFeilds contact-form form-vertical">
              <form action="{{ route('contact.send') }}" method="post"  id="contact_form" class="contact-form">	
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                          <input type="tel" id="phone" name="phone" pattern="[0-9\-]*" placeholder="Phone Number" value="{{ old('phone') }}" required>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                ...
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        <textarea rows="10" id="message" name="message" placeholder="Your Message" required>{{ old('message') }}</textarea>
                      </div>
                  </div>  
                </div>
                <div class="row">
